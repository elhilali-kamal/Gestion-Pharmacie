...
namespace Projet_Control_2 {
    ...
    public partial class DataSetSupplier : global::System.Data.DataSet {
        ...
        public partial class supplierDataTable : global::System.Data.TypedTableBase<supplierRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public supplierRow AddsupplierRow(string suppliername, string phone, string adress) {
...
namespace Projet_Control_2.DataSetSupplierTableAdapters {
    ...
    public partial class supplierTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[supplier] ([suppliername], [phone], [adress]) VALUES (@supplie" +
                "rname, @phone, @adress);\r\nSELECT supplierid, suppliername, phone, adress FROM su" +
                "pplier WHERE (supplierid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[supplier] SET [suppliername] = @suppliername, [phone] = @phone, [adress] = @adress WHERE (([supplierid] = @Original_supplierid) AND ((@IsNull_suppliername = 1 AND [suppliername] IS NULL) OR ([suppliername] = @Original_suppliername)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_adress = 1 AND [adress] IS NULL) OR ([adress] = @Original_adress)));
SELECT supplierid, suppliername, phone, adress FROM supplier WHERE (supplierid = @supplierid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT supplierid, suppliername, phone, adress FROM dbo.supplier";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        supplierid, suppliername, phone, adress\r\nFROM            supplier\r\n" +
                "WHERE        (suppliername LIKE @search)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@search", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "suppliername", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSetSupplier.supplierDataTable dataTable) {
        ...
        public virtual DataSetSupplier.supplierDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetSupplier.supplierDataTable dataTable = new DataSetSupplier.supplierDataTable();
        ...
        public virtual int FillBy(DataSetSupplier.supplierDataTable dataTable, string search) {
        ...
        public virtual DataSetSupplier.supplierDataTable GetDataBy(string search) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((search == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetSupplier.supplierDataTable dataTable) {
        ...
        public virtual int Delete(int Original_supplierid, string Original_suppliername, string Original_phone, string Original_adress) {
        ...
        public virtual int Insert(string suppliername, string phone, string adress) {
        ...
        public virtual int Update(string suppliername, string phone, string adress, int Original_supplierid, string Original_suppliername, string Original_phone, string Original_adress, int supplierid) {
            if ((suppliername == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string suppliername, string phone, string adress, int Original_supplierid, string Original_suppliername, string Original_phone, string Original_adress) {
            return this.Update(suppliername, phone, adress, Original_supplierid, Original_suppliername, Original_phone, Original_adress, Original_supplierid);
        }
    }
